...
public class confirm_adapter extends RecyclerView.Adapter<com.armjld.eb3tly.Adapters.confirm_adapter.MyViewHolder> {
    ...
    @NonNull
    @Override
    public com.armjld.eb3tly.Adapters.confirm_adapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.card_confirmation, parent, false);
        return new com.armjld.eb3tly.Adapters.confirm_adapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull com.armjld.eb3tly.Adapters.confirm_adapter.MyViewHolder holder, final int position) {
        // --------------------------- Get Data ------------------------------ //
